...
router.get('/stats/today', authenticate, authorize('ADMIN', 'STAFF'), requireStaffPermission('ORDERS_MANAGE'), orderController.getTodaysStats);
router.get('/pending', authenticate, authorize('ADMIN', 'STAFF'), requireStaffPermission('ORDERS_MANAGE'), orderController.getPendingOrders);
...
router.put('/:id/status', authenticate, authorize('ADMIN', 'STAFF'), requireStaffPermission('ORDERS_MANAGE'), validate(idParamSchema), validate(updateOrderStatusSchema), orderController.updateStatus);
